...
- (instancetype)initWithBDModel:(Item *)bdItem {
    ...
    if (self) {
        ...
        self.title = bdItem.title;
        self.itemDescription = bdItem.itemDescription;
        self.pubDate = bdItem.pubDate;
        self.author = bdItem.author;
        self.category = bdItem.category;
        self.link = [NSURL URLWithString: bdItem.link];
        self.guid = bdItem.guid;
    }
    return self;
}
...
-(NSString *)stringFromDate {
    ...
    if (self.pubDate) {
        ...
        return [formatter stringFromDate:self.pubDate];
    }
    return nil;
}
